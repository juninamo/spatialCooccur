...
<div class="nb-source">
This article is a rendered copy of the Jupyter notebook [`vignettes/segmentation_free_tutorial.ipynb`](https://github.com/juninamo/spatialCooccur/blob/master/vignettes/segmentation_free_tutorial.ipynb); download it to run the code yourself.
</div>
